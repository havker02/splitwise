...
const Login = () => {
  ...
  return (
    <div className="mt-8 md:mt-20">
      <h1 className="text-center font-semibold text-xl md:text-5xl">Welcome to Apna Hisab</h1>
      <div className="form-container mt-8 px-4 border border-zinc-300 m-4 rounded-lg shadow-md shadow-zinc-300 py-8">
        <h2 className="text-center font-semibold text-lg md:text-4xl">Create your account</h2>
        <form 
          ...
          <button
            type="submit"
            className="mt-2 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center md:text-2xl md:font-semibold md:mt-8">Create account</button>
        </form>
